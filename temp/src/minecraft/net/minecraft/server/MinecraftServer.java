...
public abstract class MinecraftServer implements Runnable, IPlayerUsage, ICommandSender {
   ...
   protected void func_71237_c(String p_71237_1_) {
      if(this.func_71254_M().func_75801_b(p_71237_1_)) {
         ...
         this.func_71254_M().func_75805_a(p_71237_1_, new ConvertProgressUpdater(this));
      }
   ...
   protected void func_71247_a(String p_71247_1_, String p_71247_2_, long p_71247_3_, WorldType p_71247_5_) {
      ...
      ISaveHandler var6 = this.field_71310_m.func_75804_a(p_71247_1_, true);
      WorldInfo var8 = var6.func_75757_d();
      WorldSettings var7;
      if(var8 == null) {
         var7 = new WorldSettings(p_71247_3_, this.func_71265_f(), this.func_71225_e(), this.func_71199_h(), p_71247_5_);
      } else {
      ...
      for(int var9 = 0; var9 < this.field_71305_c.length; ++var9) {
         ...
         if(var9 == 0) {
            if(this.func_71242_L()) {
               this.field_71305_c[var9] = new DemoWorldServer(this, var6, p_71247_2_, var10, this.field_71304_b);
            } else {
               this.field_71305_c[var9] = new WorldServer(this, var6, p_71247_2_, var10, var7, this.field_71304_b);
            }
         } else {
            this.field_71305_c[var9] = new WorldServerMulti(this, var6, p_71247_2_, var10, var7, this.field_71305_c[0], this.field_71304_b);
         }

         this.field_71305_c[var9].func_72954_a(new WorldManager(this, this.field_71305_c[var9]));
         if(!this.func_71264_H()) {
            this.field_71305_c[var9].func_72912_H().func_76060_a(this.func_71265_f());
         }
   ...
   protected void func_71222_d() {
      ...
      for(int var4 = 0; var4 < 1; ++var4) {
         field_71306_a.info("Preparing start region for level " + var4);
         WorldServer var5 = this.field_71305_c[var4];
         ...
         for(int var7 = -var1; var7 <= var1 && this.func_71278_l(); var7 += 16) {
            for(int var8 = -var1; var8 <= var1 && this.func_71278_l(); var8 += 16) {
               ...
               if(var9 > var2 + 1000L) {
                  ...
                  this.func_71216_a_("Preparing spawn area", var12 * 100 / var11);
                  var2 = var9;
               }

               var5.field_73059_b.func_73158_c(var6.field_71574_a + var7 >> 4, var6.field_71573_c + var8 >> 4);

               while(var5.func_72968_M() && this.func_71278_l()) {
                  ;
               }
            }
         }
   ...
   protected void func_71267_a(boolean p_71267_1_) {
      if(!this.field_71290_O) {
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            ...
            if(var5 != null) {
               if(!p_71267_1_) {
                  field_71306_a.info("Saving chunks for level \'" + var5.func_72912_H().func_76065_j() + "\'/" + var5.field_73011_w);
               }
   ...
   public void func_71260_j() {
      if(!this.field_71290_O) {
         ...
         WorldServer[] var1 = this.field_71305_c;
   ...
   public void func_71190_q() {
      ...
      for(int var1 = 0; var1 < this.field_71305_c.length; ++var1) {
         ...
         if(var1 == 0 || this.func_71255_r()) {
            ...
            if(this.field_71315_w % 20 == 0) {
               ...
               this.field_71318_t.func_72396_a(new Packet4UpdateTime(var4.func_72820_D()), var4.field_73011_w.field_76574_g);
               this.field_71304_b.func_76319_b();
            }
            ...
            while(true) {
               if(!var4.func_72968_M()) {
                  this.field_71304_b.func_76319_b();
                  if(!var4.field_73010_i.isEmpty()) {
                     var4.func_72939_s();
                  }
      ...
      Iterator var5 = this.field_71322_p.iterator();
