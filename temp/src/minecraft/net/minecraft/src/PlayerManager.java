...
public class PlayerManager {
   ...
   public void func_72693_b() {
      Iterator var1 = this.field_72697_d.iterator();
      ...
      if(this.field_72699_b.isEmpty()) {
         WorldProvider var3 = this.field_72701_a.field_73011_w;
         if(!var3.func_76567_e()) {
   ...
   public boolean func_72694_a(EntityPlayerMP p_72694_1_, int p_72694_2_, int p_72694_3_) {
      ...
      return var4 == null?false:PlayerInstance.func_73258_b(var4).contains(p_72694_1_);
   }
