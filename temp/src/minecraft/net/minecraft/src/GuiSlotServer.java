...
class GuiSlotServer extends GuiSlot {
   ...
   protected void func_77213_a(int p_77213_1_, boolean p_77213_2_) {
      if(p_77213_1_ < GuiMultiplayer.func_74006_a(this.field_77250_a).func_78856_c() + GuiMultiplayer.func_74003_b(this.field_77250_a).size()) {
         ...
         boolean var4 = GuiMultiplayer.func_74020_c(this.field_77250_a) >= 0 && GuiMultiplayer.func_74020_c(this.field_77250_a) < this.func_77217_a();
         boolean var5 = GuiMultiplayer.func_74020_c(this.field_77250_a) < GuiMultiplayer.func_74006_a(this.field_77250_a).func_78856_c();
         GuiMultiplayer.func_74014_d(this.field_77250_a).field_73742_g = var4;
         GuiMultiplayer.func_74005_e(this.field_77250_a).field_73742_g = var5;
         GuiMultiplayer.func_74019_f(this.field_77250_a).field_73742_g = var5;
         if(p_77213_2_ && var4) {
            GuiMultiplayer.func_74008_b(this.field_77250_a, p_77213_1_);
         } else if(var5 && GuiScreen.func_73877_p() && var3 >= 0 && var3 < GuiMultiplayer.func_74006_a(this.field_77250_a).func_78856_c()) {
   ...
   private void func_77247_d(int p_77247_1_, int p_77247_2_, int p_77247_3_, int p_77247_4_, Tessellator p_77247_5_) {
      ...
      if(var6.field_78841_f && var6.field_78844_e != -2L) {
         ...
         var7 = 1;
         var8 = (int)(Minecraft.func_71386_F() / 100L + (long)(p_77247_1_ * 2) & 7L);
         if(var8 > 4) {
            var8 = 8 - var8;
         }
      ...
      this.field_77250_a.func_73729_b(p_77247_2_ + 205, p_77247_3_, 0 + var7 * 10, 176 + var8 * 8, 10, 8);
      byte var10 = 4;
      if(this.field_77230_e >= p_77247_2_ + 205 - var10 && this.field_77227_f >= p_77247_3_ - var10 && this.field_77230_e <= p_77247_2_ + 205 + 10 + var10 && this.field_77227_f <= p_77247_3_ + 8 + var10) {
         GuiMultiplayer.func_74009_a(this.field_77250_a, var9);
      }
