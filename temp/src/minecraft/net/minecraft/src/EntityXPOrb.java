...
public class EntityXPOrb extends Entity {
   ...
   public void func_70071_h_() {
      ...
      double var1 = 8.0D;
      EntityPlayer var3 = this.field_70170_p.func_72890_a(this, var1);
      if(var3 != null) {
         double var4 = (var3.field_70165_t - this.field_70165_t) / var1;
         double var6 = (var3.field_70163_u + (double)var3.func_70047_e() - this.field_70163_u) / var1;
         double var8 = (var3.field_70161_v - this.field_70161_v) / var1;
         double var10 = Math.sqrt(var4 * var4 + var6 * var6 + var8 * var8);
         double var12 = 1.0D - var10;
         if(var12 > 0.0D) {
            var12 *= var12;
            this.field_70159_w += var4 / var10 * var12 * 0.1D;
            this.field_70181_x += var6 / var10 * var12 * 0.1D;
            this.field_70179_y += var8 / var10 * var12 * 0.1D;
         }
      }
      ...
      if(this.field_70122_E) {
         ...
         if(var5 > 0) {
            var14 = Block.field_71973_m[var5].field_72016_cq * 0.98F;
         }
      }

      this.field_70159_w *= (double)var14;
      this.field_70181_x *= 0.9800000190734863D;
      this.field_70179_y *= (double)var14;
      if(this.field_70122_E) {
