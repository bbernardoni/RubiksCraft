...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant {
   ...
   private void addModTrades(MerchantRecipeList var1) {
      List var2 = ModLoader.getTrades(this.func_70946_n());
      if(var2 != null) {
         ...
         while(var3.hasNext()) {
            ...
            if(var4.buying) {
               func_70948_a(var1, var4.id, this.field_70146_Z, var4.chance);
            } else {
               func_70949_b(var1, var4.id, this.field_70146_Z, var4.chance);
            }
         }
      ...
      while(var1.hasNext()) {
         ...
         if(var2.buying) {
            if(var2.min > 0 && var2.max > 0) {
               field_70958_bB.put(Integer.valueOf(var2.id), new Tuple(Integer.valueOf(var2.min), Integer.valueOf(var2.max)));
            }
         } else if(var2.min > 0 && var2.max > 0) {
            field_70960_bC.put(Integer.valueOf(var2.id), new Tuple(Integer.valueOf(var2.min), Integer.valueOf(var2.max)));
         }
      }
