...
public class GenLayerBiome extends GenLayer {
   ...
   public static BiomeGenBase[] biomeArray = new BiomeGenBase[]{BiomeGenBase.field_76769_d, BiomeGenBase.field_76767_f, BiomeGenBase.field_76770_e, BiomeGenBase.field_76780_h, BiomeGenBase.field_76772_c, BiomeGenBase.field_76768_g, BiomeGenBase.field_76782_w};
   private BiomeGenBase[] field_75914_b;


   public GenLayerBiome(long p_i3888_1_, GenLayer p_i3888_3_, WorldType p_i3888_4_) {
      super(p_i3888_1_);
      this.field_75914_b = biomeArray;
