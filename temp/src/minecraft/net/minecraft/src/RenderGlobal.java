...
public class RenderGlobal implements IWorldAccess {
   ...
   public void func_72712_a() {
      if(this.field_72769_h != null) {
         ...
         if(this.field_72765_l != null) {
            WorldRenderer[] var1 = this.field_72765_l;
            var2 = var1.length;
         ...
         int var7 = 64 << 3 - this.field_72739_F;
         if(var7 > 400) {
            var7 = 400;
         }

         this.field_72766_m = var7 / 16 + 1;
         this.field_72763_n = 16;
         this.field_72764_o = var7 / 16 + 1;
         ...
         WorldRenderer var5;
         for(Iterator var8 = this.field_72767_j.iterator(); var8.hasNext(); var5.field_78939_q = false) {
         ...
         for(int var9 = 0; var9 < this.field_72766_m; ++var9) {
            for(int var11 = 0; var11 < this.field_72763_n; ++var11) {
               for(int var6 = 0; var6 < this.field_72764_o; ++var6) {
                  this.field_72765_l[(var6 * this.field_72763_n + var11) * this.field_72766_m + var9] = new WorldRenderer(this.field_72769_h, this.field_72762_a, var9 * 16, var11 * 16, var6 * 16, this.field_72778_p + var2);
                  if(this.field_72774_t) {
                     this.field_72765_l[(var6 * this.field_72763_n + var11) * this.field_72766_m + var9].field_78934_v = this.field_72775_s.get(var3);
                  }

                  this.field_72765_l[(var6 * this.field_72763_n + var11) * this.field_72766_m + var9].field_78935_u = false;
                  this.field_72765_l[(var6 * this.field_72763_n + var11) * this.field_72766_m + var9].field_78936_t = true;
                  this.field_72765_l[(var6 * this.field_72763_n + var11) * this.field_72766_m + var9].field_78927_l = true;
                  this.field_72765_l[(var6 * this.field_72763_n + var11) * this.field_72766_m + var9].field_78937_s = var3++;
                  this.field_72765_l[(var6 * this.field_72763_n + var11) * this.field_72766_m + var9].func_78914_f();
                  this.field_72768_k[(var6 * this.field_72763_n + var11) * this.field_72766_m + var9] = this.field_72765_l[(var6 * this.field_72763_n + var11) * this.field_72766_m + var9];
                  this.field_72767_j.add(this.field_72765_l[(var6 * this.field_72763_n + var11) * this.field_72766_m + var9]);
                  var2 += 3;
               }
            }
         }
         ...
         if(this.field_72769_h != null) {
            EntityLiving var10 = this.field_72777_q.field_71451_h;
            if(var10 != null) {
               this.func_72722_c(MathHelper.func_76128_c(var10.field_70165_t), MathHelper.func_76128_c(var10.field_70163_u), MathHelper.func_76128_c(var10.field_70161_v));
               Arrays.sort(this.field_72768_k, new EntitySorter(var10));
            }
         }
   ...
   public void func_72713_a(Vec3 p_72713_1_, ICamera p_72713_2_, float p_72713_3_) {
      if(this.field_72740_G > 0) {
         ...
         for(var6 = 0; var6 < var5.size(); ++var6) {
            ...
            if(var7.func_70102_a(p_72713_1_) && (var7.field_70158_ak || p_72713_2_.func_78546_a(var7.field_70121_D)) && (var7 != this.field_72777_q.field_71451_h || this.field_72777_q.field_71474_y.field_74320_O != 0 || this.field_72777_q.field_71451_h.func_70608_bn()) && this.field_72769_h.func_72899_e(MathHelper.func_76128_c(var7.field_70165_t), 0, MathHelper.func_76128_c(var7.field_70161_v))) {
               ++this.field_72749_I;
               RenderManager.field_78727_a.func_78720_a(var7, p_72713_3_);
            }
         }
         ...
         Iterator var8 = this.field_72762_a.iterator();

         while(var8.hasNext()) {
            TileEntity var9 = (TileEntity)var8.next();
            TileEntityRenderer.field_76963_a.func_76950_a(var9, p_72713_3_);
         }
   ...
   private int func_72724_a(int p_72724_1_, int p_72724_2_, int p_72724_3_, double p_72724_4_) {
      ...
      int var14 = 0;
      RenderList[] var15 = this.field_72754_S;
      ...
      WorldRenderer var22;
      for(Iterator var21 = this.field_72755_R.iterator(); var21.hasNext(); this.field_72754_S[var17].func_78420_a(var22.func_78909_a(p_72724_3_))) {
         var22 = (WorldRenderer)var21.next();
         var17 = -1;

         for(int var23 = 0; var23 < var14; ++var23) {
            if(this.field_72754_S[var23].func_78418_a(var22.field_78918_f, var22.field_78919_g, var22.field_78931_h)) {
               var17 = var23;
            }
         }
         ...
         if(var17 < 0) {
            var17 = var14++;
            this.field_72754_S[var17].func_78422_a(var22.field_78918_f, var22.field_78919_g, var22.field_78931_h, var20, var10, var12);
         }
      }
   ...
   public void func_72733_a(int p_72733_1_, double p_72733_2_) {
      ...
      RenderList[] var4 = this.field_72754_S;
   ...
   public void func_72702_a(String p_72702_1_, int p_72702_2_, int p_72702_3_, int p_72702_4_) {
      if(p_72702_1_ != null) {
         this.field_72777_q.field_71456_v.func_73833_a("C418 - " + p_72702_1_);
      }

      this.field_72777_q.field_71416_A.func_77368_a(p_72702_1_, (float)p_72702_2_, (float)p_72702_3_, (float)p_72702_4_, 1.0F, 1.0F);
   }
            ...
            if(var15 * var15 + var17 * var17 + var19 * var19 > var22 * var22) {
               ...
               if(p_72726_1_.equals("bubble")) {
                  ...
                  if(p_72726_1_.startsWith("iconcrack_")) {
                     var24 = Integer.parseInt(p_72726_1_.substring(p_72726_1_.indexOf("_") + 1));
                     var21 = new EntityBreakingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_, Item.field_77698_e[var24]);
                  } else if(p_72726_1_.startsWith("tilecrack_")) {
                     var24 = Integer.parseInt(p_72726_1_.substring(p_72726_1_.indexOf("_") + 1));
                     var21 = new EntityDiggingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_, Block.field_71973_m[var24], 0, 0);
                  }
               }
   ...
   public void func_72706_a(EntityPlayer p_72706_1_, int p_72706_2_, int p_72706_3_, int p_72706_4_, int p_72706_5_, int p_72706_6_) {
      ...
      case 2002:
         ...
         var15 = Item.field_77726_bs.func_77620_a(p_72706_6_, 0);
