...
public class ItemRenderer {
   ...
   public void func_78440_a(float p_78440_1_) {
      ...
      if(var3 instanceof EntityPlayerSP) {
         var6 = var3.field_71164_i + (var3.field_71155_g - var3.field_71164_i) * p_78440_1_;
         float var7 = var3.field_71163_h + (var3.field_71154_f - var3.field_71163_h) * p_78440_1_;
         GL11.glRotatef((var3.field_70125_A - var6) * 0.1F, 1.0F, 0.0F, 0.0F);
         GL11.glRotatef((var3.field_70177_z - var7) * 0.1F, 0.0F, 1.0F, 0.0F);
      }

      ItemStack var5 = this.field_78453_b;
      ...
      var6 = 1.0F;
      int var20 = this.field_78455_a.field_71441_e.func_72802_i(MathHelper.func_76128_c(var3.field_70165_t), MathHelper.func_76128_c(var3.field_70163_u), MathHelper.func_76128_c(var3.field_70161_v), 0);
      ...
      float var13;
      if(var5 != null) {
         int var10 = Item.field_77698_e[var5.field_77993_c].func_77620_a(var5.func_77960_j(), 0);
         var11 = (float)(var10 >> 16 & 255) / 255.0F;
         var12 = (float)(var10 >> 8 & 255) / 255.0F;
         var13 = (float)(var10 & 255) / 255.0F;
         GL11.glColor4f(var6 * var11, var6 * var12, var6 * var13, 1.0F);
      } else {
      ...
      if(var5 != null && var5.field_77993_c == Item.field_77744_bd.field_77779_bT) {
         GL11.glPushMatrix();
         var22 = 0.8F;
         var11 = var3.func_70678_g(p_78440_1_);
         var12 = MathHelper.func_76126_a(var11 * 3.1415927F);
         var13 = MathHelper.func_76126_a(MathHelper.func_76129_c(var11) * 3.1415927F);
         GL11.glTranslatef(-var13 * 0.4F, MathHelper.func_76126_a(MathHelper.func_76129_c(var11) * 3.1415927F * 2.0F) * 0.2F, -var12 * 0.2F);
         ...
         var11 = -MathHelper.func_76134_b(var11 * 3.1415927F) * 0.5F + 0.5F;
         GL11.glTranslatef(0.0F, 0.0F * var22 - (1.0F - var2) * 1.2F - var11 * 0.5F + 0.04F, -0.9F * var22);
         ...
         for(var12 = 0.0F; var12 < 2.0F; ++var12) {
            var13 = var12 * 2.0F - 1.0F;
            GL11.glPushMatrix();
            GL11.glTranslatef(-0.0F, -0.6F, 1.1F * var13);
            GL11.glRotatef(-45.0F * var13, 1.0F, 0.0F, 0.0F);
            GL11.glRotatef(-90.0F, 0.0F, 0.0F, 1.0F);
            GL11.glRotatef(59.0F, 0.0F, 0.0F, 1.0F);
            GL11.glRotatef(-65.0F * var13, 0.0F, 1.0F, 0.0F);
            var25 = RenderManager.field_78727_a.func_78713_a(this.field_78455_a.field_71439_g);
            var24 = (RenderPlayer)var25;
            var16 = 1.0F;
         ...
         var13 = MathHelper.func_76126_a(var12 * var12 * 3.1415927F);
         ...
         var28.func_78381_a();
         MapData var19 = Item.field_77744_bd.func_77873_a(var5, this.field_78455_a.field_71441_e);
         this.field_78449_f.func_78319_a(this.field_78455_a.field_71439_g, this.field_78455_a.field_71446_o, var19);
         GL11.glPopMatrix();
      } else if(var5 != null) {
         GL11.glPushMatrix();
         var22 = 0.8F;
         if(var3.func_71052_bv() > 0) {
            EnumAction var21 = var5.func_77975_n();
            if(var21 == EnumAction.eat || var21 == EnumAction.drink) {
               var12 = (float)var3.func_71052_bv() - p_78440_1_ + 1.0F;
               var13 = 1.0F - var12 / (float)var5.func_77988_m();
               var14 = 1.0F - var13;
               var14 = var14 * var14 * var14;
               var14 = var14 * var14 * var14;
               var14 = var14 * var14 * var14;
               var15 = 1.0F - var14;
               GL11.glTranslatef(0.0F, MathHelper.func_76135_e(MathHelper.func_76134_b(var12 / 4.0F * 3.1415927F) * 0.1F) * (float)((double)var13 <= 0.2D?0:1), 0.0F);
         ...
         GL11.glEnable('\u803a');
         var11 = var3.func_70678_g(p_78440_1_);
         var12 = MathHelper.func_76126_a(var11 * var11 * 3.1415927F);
         var13 = MathHelper.func_76126_a(MathHelper.func_76129_c(var11) * 3.1415927F);
         ...
         float var18;
         if(var3.func_71052_bv() > 0) {
            EnumAction var23 = var5.func_77975_n();
            if(var23 == EnumAction.block) {
               ...
               var16 = (float)var5.func_77988_m() - ((float)var3.func_71052_bv() - p_78440_1_ + 1.0F);
               var17 = var16 / 20.0F;
         ...
         if(var5.func_77973_b().func_77629_n_()) {
            GL11.glRotatef(180.0F, 0.0F, 1.0F, 0.0F);
         }

         if(var5.func_77973_b().func_77623_v()) {
            this.func_78443_a(var3, var5, 0);
            int var26 = Item.field_77698_e[var5.field_77993_c].func_77620_a(var5.func_77960_j(), 1);
            var16 = (float)(var26 >> 16 & 255) / 255.0F;
            var17 = (float)(var26 >> 8 & 255) / 255.0F;
            var18 = (float)(var26 & 255) / 255.0F;
            GL11.glColor4f(var6 * var16, var6 * var17, var6 * var18, 1.0F);
            this.func_78443_a(var3, var5, 1);
         } else {
            this.func_78443_a(var3, var5, 0);
         }
         ...
         var12 = MathHelper.func_76126_a(var11 * 3.1415927F);
         var13 = MathHelper.func_76126_a(MathHelper.func_76129_c(var11) * 3.1415927F);
         GL11.glTranslatef(-var13 * 0.3F, MathHelper.func_76126_a(MathHelper.func_76129_c(var11) * 3.1415927F * 2.0F) * 0.4F, -var12 * 0.4F);
