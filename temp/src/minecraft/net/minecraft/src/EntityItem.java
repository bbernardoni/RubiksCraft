   ...
   public void func_70071_h_() {
      ...
      if(var1) {
         ...
         if(!this.field_70170_p.field_72995_K) {
            Iterator var3 = this.field_70170_p.func_72872_a(EntityItem.class, this.field_70121_D.func_72314_b(0.5D, 0.0D, 0.5D)).iterator();
      ...
      if(this.field_70122_E) {
         ...
         if(var5 > 0) {
            var4 = Block.field_71973_m[var5].field_72016_cq * 0.98F;
         }
      }
   ...
   public void func_70100_b_(EntityPlayer p_70100_1_) {
      if(!this.field_70170_p.field_72995_K) {
         ...
         if(this.field_70293_c == 0 && p_70100_1_.field_71071_by.func_70441_a(this.field_70294_a)) {
            ...
            ModLoader.onItemPickup(p_70100_1_, this.field_70294_a);
