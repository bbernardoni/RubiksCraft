...
public class GuiIngame extends Gui {
   ...
   public void func_73830_a(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_) {
      ...
      if(this.field_73839_d.func_71355_q()) {
         ...
         String var36 = "";
         if(this.field_73839_d.field_71441_e.func_72820_D() >= 120500L) {
            var36 = StatCollector.func_74838_a("demo.demoExpired");
         } else {
            var36 = String.format(StatCollector.func_74838_a("demo.remainingTime"), new Object[]{StringUtils.func_76337_a((int)(120500L - this.field_73839_d.field_71441_e.func_72820_D()))});
         }
      ...
      if(this.field_73839_d.field_71474_y.field_74330_P) {
         ...
         GL11.glPushMatrix();
         var8.func_78261_a("Minecraft 1.3.1 (" + this.field_73839_d.field_71426_K + ")", 2, 2, 16777215);
         ...
         this.func_73731_b(var8, String.format("x: %.5f", new Object[]{Double.valueOf(this.field_73839_d.field_71439_g.field_70165_t)}), 2, 64, 14737632);
         ...
         this.func_73731_b(var8, String.format("z: %.5f", new Object[]{Double.valueOf(this.field_73839_d.field_71439_g.field_70161_v)}), 2, 80, 14737632);
         this.func_73731_b(var8, "f: " + (MathHelper.func_76128_c((double)(this.field_73839_d.field_71439_g.field_70177_z * 4.0F / 360.0F) + 0.5D) & 3), 2, 88, 14737632);
         ...
         if(this.field_73839_d.field_71441_e != null && this.field_73839_d.field_71441_e.func_72899_e(var47, var22, var23)) {
            Chunk var48 = this.field_73839_d.field_71441_e.func_72938_d(var47, var23);
            this.func_73731_b(var8, "lc: " + (var48.func_76625_h() + 15) + " b: " + var48.func_76591_a(var47 & 15, var23 & 15, this.field_73839_d.field_71441_e.func_72959_q()).field_76791_y + " bl: " + var48.func_76614_a(EnumSkyBlock.Block, var47 & 15, var22, var23 & 15) + " sl: " + var48.func_76614_a(EnumSkyBlock.Sky, var47 & 15, var22, var23 & 15) + " rl: " + var48.func_76629_c(var47 & 15, var22, var23 & 15, 0), 2, 96, 14737632);
         }

         this.func_73731_b(var8, String.format("ws: %.3f, fs: %.3f, g: %b", new Object[]{Float.valueOf(this.field_73839_d.field_71439_g.field_71075_bZ.func_75094_b()), Float.valueOf(this.field_73839_d.field_71439_g.field_71075_bZ.func_75093_a()), Boolean.valueOf(this.field_73839_d.field_71439_g.field_70122_E)}), 2, 104, 14737632);
         GL11.glPopMatrix();
         this.field_73839_d.field_71424_I.func_76319_b();
      }
      ...
      if(this.field_73839_d.field_71474_y.field_74321_H.field_74513_e && (!this.field_73839_d.func_71387_A() || this.field_73839_d.field_71439_g.field_71174_a.field_72559_c.size() > 1)) {
         ...
         for(var19 = 0; var19 < var13; ++var19) {
            ...
            if(var19 < var39.size()) {
               ...
               this.func_73729_b(var20 + var16 - 12, var47, 0 + var51 * 10, 176 + var50 * 8, 10, 8);
               this.field_73735_i -= 100.0F;
            }
         }
      }
   ...
   private void func_73828_d() {
      if(RenderDragon.field_77085_a != null) {
         EntityDragon var1 = RenderDragon.field_77085_a;
         RenderDragon.field_77085_a = null;
         FontRenderer var2 = this.field_73839_d.field_71466_p;
         ScaledResolution var3 = new ScaledResolution(this.field_73839_d.field_71474_y, this.field_73839_d.field_71443_c, this.field_73839_d.field_71440_d);
         int var4 = var3.func_78326_a();
         short var5 = 182;
         int var6 = var4 / 2 - var5 / 2;
         int var7 = (int)((float)var1.func_70968_i() / (float)var1.func_70667_aM() * (float)(var5 + 1));
         byte var8 = 12;
         this.func_73729_b(var6, var8, 0, 74, var5, 5);
         this.func_73729_b(var6, var8, 0, 74, var5, 5);
         if(var7 > 0) {
            this.func_73729_b(var6, var8, 0, 79, var7, 5);
         }

         String var9 = "Boss health";
         var2.func_78261_a(var9, var4 / 2 - var2.func_78256_a(var9) / 2, var8 - 10, 16711935);
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         GL11.glBindTexture(3553, this.field_73839_d.field_71446_o.func_78341_b("/gui/icons.png"));
      }
   }
   ...
   private void func_73832_a(int p_73832_1_, int p_73832_2_, int p_73832_3_, float p_73832_4_) {
      ...
      if(var5 != null) {
         ...
         field_73841_b.func_77015_a(this.field_73839_d.field_71466_p, this.field_73839_d.field_71446_o, var5, p_73832_2_, p_73832_3_);
         if(var6 > 0.0F) {
            GL11.glPopMatrix();
         }
