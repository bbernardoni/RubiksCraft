...
import net.minecraft.src.GuiSnooperList;
...
public class GuiSnooper extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      var3 = (new TreeMap(this.field_73882_e.func_71378_E().func_76465_c())).entrySet().iterator();

      while(var3.hasNext()) {
         Entry var5 = (Entry)var3.next();
         this.field_74098_c.add(var5.getKey());
         this.field_74096_d.add(this.field_73886_k.func_78269_a((String)var5.getValue(), this.field_73880_f - 210));
      }
