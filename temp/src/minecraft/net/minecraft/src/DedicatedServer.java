...
public class DedicatedServer extends MinecraftServer implements IServer {
   ...
   protected boolean func_71197_b() throws IOException {
      ...
      try {
         ...
         field_71306_a.log(Level.WARNING, "The exception was: " + var15.toString());
      ...
      WorldType var16 = WorldType.func_77130_a(var7);
      if(var16 == null) {
         var16 = WorldType.field_77137_b;
      }
      ...
      field_71306_a.info("Done (" + var13 + ")! For help, type \"help\" or \"?\"");
