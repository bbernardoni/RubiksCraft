...
public class BlockDispenser extends BlockContainer {
   ...
   private void func_72281_c(World p_72281_1_, int p_72281_2_, int p_72281_3_, int p_72281_4_, Random p_72281_5_) {
      ...
      TileEntityDispenser var9 = (TileEntityDispenser)p_72281_1_.func_72796_p(p_72281_2_, p_72281_3_, p_72281_4_);
      if(var9 != null) {
         int var10 = var9.func_70361_i();
         if(var10 < 0) {
            p_72281_1_.func_72926_e(1001, p_72281_2_, p_72281_3_, p_72281_4_, 0);
         } else {
            double var11 = (double)p_72281_2_ + (double)var7 * 0.6D + 0.5D;
            double var13 = (double)p_72281_3_ + 0.5D;
            double var15 = (double)p_72281_4_ + (double)var8 * 0.6D + 0.5D;
            ItemStack var17 = var9.func_70301_a(var10);
            int var18 = func_72283_a(var9, p_72281_1_, var17, p_72281_5_, p_72281_2_, p_72281_3_, p_72281_4_, var7, var8, var11, var13, var15);
            if(var18 == 1) {
               var9.func_70298_a(var10, 1);
            } else if(var18 == 0) {
               ItemStack var19 = var9.func_70298_a(var10, 1);
               func_72282_a(p_72281_1_, var19, p_72281_5_, 6, var7, var8, var11, var13, var15);
               p_72281_1_.func_72926_e(1000, p_72281_2_, p_72281_3_, p_72281_4_, 0);
            }

            p_72281_1_.func_72926_e(2000, p_72281_2_, p_72281_3_, p_72281_4_, var7 + 1 + (var8 + 1) * 3);
         }
      }
   ...
   private static int func_72283_a(TileEntityDispenser p_72283_0_, World p_72283_1_, ItemStack p_72283_2_, Random p_72283_3_, int p_72283_4_, int p_72283_5_, int p_72283_6_, int p_72283_7_, int p_72283_8_, double p_72283_9_, double p_72283_11_, double p_72283_13_) {
      ...
      if(p_72283_2_.field_77993_c == Item.field_77704_l.field_77779_bT) {
         ...
         if(p_72283_2_.field_77993_c == Item.field_77788_aw.field_77779_bT) {
            ...
            p_72283_9_ = (double)p_72283_4_ + (p_72283_7_ >= 0?(double)((float)p_72283_7_ * 1.8F):(double)p_72283_7_ * 0.8D) + (double)((float)Math.abs(p_72283_8_) * 0.5F);
            p_72283_13_ = (double)p_72283_6_ + (p_72283_8_ >= 0?(double)((float)p_72283_8_ * 1.8F):(double)p_72283_8_ * 0.8D) + (double)((float)Math.abs(p_72283_7_) * 0.5F);
