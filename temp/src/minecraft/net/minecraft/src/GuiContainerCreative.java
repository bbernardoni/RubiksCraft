...
public class GuiContainerCreative extends InventoryEffectRenderer {
   ...
   protected void func_74191_a(Slot p_74191_1_, int p_74191_2_, int p_74191_3_, boolean p_74191_4_) {
      ...
      if(p_74191_1_ != null) {
         int var5;
         if(p_74191_1_ == this.field_74235_v && p_74191_4_) {
            for(var5 = 0; var5 < this.field_73882_e.field_71439_g.field_71069_bz.func_75138_a().size(); ++var5) {
               this.field_73882_e.field_71442_b.func_78761_a((ItemStack)null, var5);
            }
            ...
            if(p_74191_1_ == this.field_74235_v) {
               ...
               var5 = SlotCreativeInventory.func_75240_a((SlotCreativeInventory)p_74191_1_).field_75222_d;
               if(p_74191_4_) {
                  this.field_73882_e.field_71442_b.func_78761_a((ItemStack)null, var5);
               } else {
                  this.field_73882_e.field_71439_g.field_71069_bz.func_75144_a(var5, p_74191_3_, p_74191_4_, this.field_73882_e.field_71439_g);
                  var6 = this.field_73882_e.field_71439_g.field_71069_bz.func_75139_a(var5).func_75211_c();
                  this.field_73882_e.field_71442_b.func_78761_a(var6, var5);
               }
            }
         } else if(p_74191_1_.field_75224_c == field_74242_o) {
            var9 = this.field_73882_e.field_71439_g.field_71071_by;
            var6 = var9.func_70445_o();
            ItemStack var7 = p_74191_1_.func_75211_c();
            if(var6 != null && var7 != null && var6.func_77969_a(var7)) {
               if(p_74191_3_ == 0) {
                  if(p_74191_4_) {
                     var6.field_77994_a = var6.func_77976_d();
                  } else if(var6.field_77994_a < var6.func_77976_d()) {
                     ++var6.field_77994_a;
                  }
               } else if(var6.field_77994_a <= 1) {
                  var9.func_70437_b((ItemStack)null);
               } else {
                  --var6.field_77994_a;
               }
               ...
               boolean var8 = false;
               if(!var8) {
                  var9.func_70437_b(ItemStack.func_77944_b(var7));
                  var6 = var9.func_70445_o();
                  if(p_74191_4_) {
                     var6.field_77994_a = var6.func_77976_d();
                  }
         ...
         var9 = this.field_73882_e.field_71439_g.field_71071_by;
         if(var9.func_70445_o() != null) {
            if(p_74191_3_ == 0) {
               this.field_73882_e.field_71439_g.func_71021_b(var9.func_70445_o());
               this.field_73882_e.field_71442_b.func_78752_a(var9.func_70445_o());
               var9.func_70437_b((ItemStack)null);
            }

            if(p_74191_3_ == 1) {
               var6 = var9.func_70445_o().func_77979_a(1);
               this.field_73882_e.field_71439_g.func_71021_b(var6);
               this.field_73882_e.field_71442_b.func_78752_a(var6);
               if(var9.func_70445_o().field_77994_a == 0) {
                  var9.func_70437_b((ItemStack)null);
               }
            }
         }
   ...
   private void func_74228_j() {
      ...
      while(var8.hasNext()) {
         ...
         boolean var11 = false;
         Iterator var6 = var10.func_77968_r().iterator();
   ...
   protected void func_74189_g() {
      CreativeTabs var1 = CreativeTabs.field_78032_a[field_74241_p];
      if(var1.func_78019_g()) {
         this.field_73886_k.func_78276_b(var1.func_78024_c(), 8, 6, 4210752);
      }
   ...
   protected void func_74233_a(CreativeTabs p_74233_1_) {
      ...
      field_74196_a.func_77015_a(this.field_73886_k, this.field_73882_e.field_71446_o, var10, var7, var8);
