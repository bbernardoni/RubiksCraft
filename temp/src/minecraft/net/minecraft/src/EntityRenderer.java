...
public class EntityRenderer {
      ...
      if(var2.func_70608_bn()) {
         ...
         if(this.field_78531_r.field_71474_y.field_74325_U) {
            ...
            for(int var20 = 0; var20 < 8; ++var20) {
               ...
               var22 *= 0.1F;
               var23 *= 0.1F;
               MovingObjectPosition var24 = this.field_78531_r.field_71441_e.func_72933_a(Vec3.func_72437_a().func_72345_a(var4 + (double)var21, var6 + (double)var22, var8 + (double)var23), Vec3.func_72437_a().func_72345_a(var4 - var14 + (double)var21 + (double)var23, var6 - var18 + (double)var22, var8 - var16 + (double)var23));
               if(var24 != null) {
                  double var25 = var24.field_72307_f.func_72438_d(Vec3.func_72437_a().func_72345_a(var4, var6, var8));
                  if(var25 < var27) {
                     var27 = var25;
                  }
               }
   ...
   private void func_78472_g() {
      WorldClient var1 = this.field_78531_r.field_71441_e;
      if(var1 != null) {
         for(int var2 = 0; var2 < 256; ++var2) {
            float var3 = var1.func_72971_b(1.0F) * 0.95F + 0.05F;
            float var4 = var1.field_73011_w.field_76573_f[var2 / 16] * var3;
            float var5 = var1.field_73011_w.field_76573_f[var2 % 16] * (this.field_78514_e * 0.1F + 1.5F);
            if(var1.field_73015_s > 0) {
               var4 = var1.field_73011_w.field_76573_f[var2 / 16];
            }
            ...
            if(var1.field_73011_w.field_76574_g == 1) {
               var12 = 0.22F + var5 * 0.75F;
               var13 = 0.28F + var10 * 0.75F;
               var14 = 0.25F + var11 * 0.75F;
            }

            float var15 = this.field_78531_r.field_71474_y.field_74333_Y;
            if(var12 > 1.0F) {
               var12 = 1.0F;
            }
            ...
            this.field_78504_Q[var2] = var19 << 24 | var20 << 16 | var21 << 8 | var22;
         }
   ...
   public void func_78480_b(float p_78480_1_) {
      ...
      } else if(Minecraft.func_71386_F() - this.field_78508_Y > 500L) {
         this.field_78531_r.func_71385_j();
      }

      this.field_78531_r.field_71424_I.func_76320_a("mouse");
      if(this.field_78531_r.field_71415_G) {
         ...
         float var4 = (float)this.field_78531_r.field_71417_B.field_74377_a * var3;
         float var5 = (float)this.field_78531_r.field_71417_B.field_74375_b * var3;
         byte var6 = 1;
         ...
         if(this.field_78531_r.field_71474_y.field_74326_T) {
            this.field_78496_H += var4;
            this.field_78497_I += var5;
            float var7 = p_78480_1_ - this.field_78492_L;
            this.field_78492_L = p_78480_1_;
            var4 = this.field_78498_J * var7;
            var5 = this.field_78499_K * var7;
            this.field_78531_r.field_71439_g.func_70082_c(var4, var5 * (float)var6);
         } else {
            this.field_78531_r.field_71439_g.func_70082_c(var4, var5 * (float)var6);
         }
      }
      ...
      if(!this.field_78531_r.field_71454_w) {
         ...
         ScaledResolution var8 = new ScaledResolution(this.field_78531_r.field_71474_y, this.field_78531_r.field_71443_c, this.field_78531_r.field_71440_d);
         int var9 = var8.func_78326_a();
         int var10 = var8.func_78328_b();
         int var11 = Mouse.getX() * var9 / this.field_78531_r.field_71443_c;
         int var13 = var10 - Mouse.getY() * var10 / this.field_78531_r.field_71440_d - 1;
         int var12 = func_78465_a(this.field_78531_r.field_71474_y.field_74350_i);
         if(this.field_78531_r.field_71441_e != null) {
            ...
            if(this.field_78531_r.field_71474_y.field_74350_i == 0) {
               ...
               this.func_78471_a(p_78480_1_, this.field_78510_Z + (long)(1000000000 / var12));
            }
            ...
            if(!this.field_78531_r.field_71474_y.field_74319_N || this.field_78531_r.field_71462_r != null) {
               this.field_78531_r.field_71456_v.func_73830_a(p_78480_1_, this.field_78531_r.field_71462_r != null, var11, var13);
            }
         ...
         if(this.field_78531_r.field_71462_r != null) {
            GL11.glClear(256);
            this.field_78531_r.field_71462_r.func_73863_a(var11, var13, p_78480_1_);
            ...
            if(var19 <= var5 + var7 && var19 >= var5 - var7 && var21.func_76738_d() && var21.func_76743_j() >= 0.2F) {
               ...
               if(var20 > 0) {
                  if(Block.field_71973_m[var20].field_72018_cp == Material.field_76256_h) {
                     this.field_78531_r.field_71452_i.func_78873_a(new EntitySmokeFX(var3, (double)((float)var17 + var22), (double)((float)var19 + 0.1F) - Block.field_71973_m[var20].field_72023_ci, (double)((float)var18 + var23), 0.0D, 0.0D, 0.0D));
                  } else {
                     ++var14;
                     if(this.field_78537_ab.nextInt(var14) == 0) {
                        var8 = (double)((float)var17 + var22);
                        var10 = (double)((float)var19 + 0.1F) - Block.field_71973_m[var20].field_72023_ci;
                        var12 = (double)((float)var18 + var23);
                     }

                     this.field_78531_r.field_71452_i.func_78873_a(new EntityRainFX(var3, (double)((float)var17 + var22), (double)((float)var19 + 0.1F) - Block.field_71973_m[var20].field_72023_ci, (double)((float)var18 + var23)));
                  }
               }
            }
         }
   ...
   private void func_78466_h(float p_78466_1_) {
      ...
      float var11;
      if(this.field_78531_r.field_71474_y.field_74339_e < 2) {
         Vec3 var10 = MathHelper.func_76126_a(var2.func_72929_e(p_78466_1_)) > 0.0F?Vec3.func_72437_a().func_72345_a(-1.0D, 0.0D, 0.0D):Vec3.func_72437_a().func_72345_a(1.0D, 0.0D, 0.0D);
      ...
      if(this.field_78531_r.field_71474_y.field_74337_g) {
         float var23 = (this.field_78518_n * 30.0F + this.field_78519_o * 59.0F + this.field_78533_p * 11.0F) / 100.0F;
         float var17 = (this.field_78518_n * 30.0F + this.field_78519_o * 70.0F) / 100.0F;
