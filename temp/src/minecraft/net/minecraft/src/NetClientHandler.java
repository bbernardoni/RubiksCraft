...
public class NetClientHandler extends NetHandler {
   ...
   public void func_72459_a(Packet21PickupSpawn p_72459_1_) {
      ...
      EntityItem var8 = new EntityItem(this.field_72564_i, var2, var4, var6, new ItemStack(p_72459_1_.field_73487_h, p_72459_1_.field_73488_i, p_72459_1_.field_73486_j));
   ...
   public void func_72511_a(Packet23VehicleSpawn p_72511_1_) {
      ...
      if(p_72511_1_.field_73527_h == 10) {
         ...
         var8 = new EntityFireball(this.field_72564_i, var2, var4, var6, (double)p_72511_1_.field_73523_e / 8000.0D, (double)p_72511_1_.field_73520_f / 8000.0D, (double)p_72511_1_.field_73521_g / 8000.0D);
         p_72511_1_.field_73528_i = 0;
      ...
      if(var8 != null) {
         ...
         if(p_72511_1_.field_73528_i > 0) {
            if(p_72511_1_.field_73527_h == 60) {
               Entity var17 = this.func_72545_a(p_72511_1_.field_73528_i);
               if(var17 instanceof EntityLiving) {
                  EntityArrow var16 = (EntityArrow)var8;
                  var16.field_70250_c = var17;
               }
            }
   ...
   public void func_72475_a(Packet22Collect p_72475_1_) {
      ...
      if(var2 != null) {
         ...
         this.field_72563_h.field_71452_i.func_78873_a(new EntityPickupFX(this.field_72563_h.field_71441_e, var2, (Entity)((Entity)var3), -0.5F));
   ...
   public void func_72524_a(Packet18Animation p_72524_1_) {
      ...
      if(var2 != null) {
         ...
         if(p_72524_1_.field_73469_b == 1) {
            ...
            var3 = (EntityPlayer)var2;
            var3.func_70999_a(false, false, false);
            ...
            if(p_72524_1_.field_73469_b == 6) {
               ...
               EntityCrit2FX var4 = new EntityCrit2FX(this.field_72563_h.field_71441_e, var2, "magicCrit");
               this.field_72563_h.field_71452_i.func_78873_a(var4);
   ...
   public void func_72519_a(Packet24MobSpawn p_72519_1_) {
      ...
      List var17 = p_72519_1_.func_73489_c();
      if(var17 != null) {
         var10.func_70096_w().func_75687_a(var17);
      }
   ...
   public void func_72466_a(Packet6SpawnPosition p_72466_1_) {
      this.field_72563_h.field_71439_g.func_71063_a(new ChunkCoordinates(p_72466_1_.field_73300_a, p_72466_1_.field_73298_b, p_72466_1_.field_73299_c));
   ...
   public void func_72484_a(Packet39AttachEntity p_72484_1_) {
      ...
      if(var2 != null) {
         ((Entity)((Entity)var2)).func_70078_a(var3);
      }
   }
   ...
   private Entity func_72545_a(int p_72545_1_) {
      return (Entity)(p_72545_1_ == this.field_72563_h.field_71439_g.field_70157_k?this.field_72563_h.field_71439_g:this.field_72564_i.func_73024_a(p_72545_1_));
   }
   ...
   public void func_72487_a(Packet130UpdateSign p_72487_1_) {
      if(this.field_72563_h.field_71441_e.func_72899_e(p_72487_1_.field_73311_a, p_72487_1_.field_73309_b, p_72487_1_.field_73310_c)) {
         TileEntity var2 = this.field_72563_h.field_71441_e.func_72796_p(p_72487_1_.field_73311_a, p_72487_1_.field_73309_b, p_72487_1_.field_73310_c);
         if(var2 instanceof TileEntitySign) {
            TileEntitySign var3 = (TileEntitySign)var2;
            if(var3.func_70409_a()) {
               for(int var4 = 0; var4 < 4; ++var4) {
                  var3.field_70412_a[var4] = p_72487_1_.field_73308_d[var4];
               }
   ...
   public void func_72468_a(Packet132TileEntityData p_72468_1_) {
      if(this.field_72563_h.field_71441_e.func_72899_e(p_72468_1_.field_73334_a, p_72468_1_.field_73332_b, p_72468_1_.field_73333_c)) {
         ...
         if(var2 != null && p_72468_1_.field_73330_d == 1 && var2 instanceof TileEntityMobSpawner) {
            ((TileEntityMobSpawner)var2).func_70307_a(p_72468_1_.field_73331_e);
         }
      }
