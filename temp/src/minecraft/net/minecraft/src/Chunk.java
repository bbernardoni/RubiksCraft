...
public class Chunk {
      ...
      for(int var6 = 0; var6 < 16; ++var6) {
         for(int var7 = 0; var7 < 16; ++var7) {
            for(int var8 = 0; var8 < var5; ++var8) {
               int var9 = p_i3772_2_[var6 << 11 | var7 << 7 | var8] & 255;
               if(var9 != 0) {
                  int var10 = var8 >> 4;
         ...
         for(int var1 = 0; var1 < 16; ++var1) {
            for(int var2 = 0; var2 < 16; ++var2) {
               if(this.field_76639_c[var1 + var2 * 16]) {
                  ...
                  int var6 = this.field_76637_e.func_72976_f(var4 - 1, var5);
                  int var7 = this.field_76637_e.func_72976_f(var4 + 1, var5);
                  int var8 = this.field_76637_e.func_72976_f(var4, var5 - 1);
                  int var9 = this.field_76637_e.func_72976_f(var4, var5 + 1);
                  if(var7 < var6) {
                     var6 = var7;
                  }
   ...
   private void func_76615_h(int p_76615_1_, int p_76615_2_, int p_76615_3_) {
      ...
      if(var5 != var4) {
         this.field_76637_e.func_72975_g(p_76615_1_, p_76615_3_, var5, var4);
   ...
   public void func_76631_c() {
      ...
      List[] var1 = this.field_76645_j;
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         List var4 = var1[var3];
         this.field_76637_e.func_72868_a(var4);
      }
   ...
   public void func_76623_d() {
      ...
      Iterator var2 = this.field_76648_i.values().iterator();

      while(var2.hasNext()) {
         TileEntity var1 = (TileEntity)var2.next();
         this.field_76637_e.func_72928_a(var1);
      }

      List[] var6 = this.field_76645_j;
      int var3 = var6.length;

      for(int var4 = 0; var4 < var3; ++var4) {
         List var5 = var6[var4];
         this.field_76637_e.func_72828_b(var5);
      }
            ...
            if(var9 != p_76588_1_ && var9.field_70121_D.func_72326_a(p_76588_2_)) {
               ...
               if(var10 != null) {
                  for(int var11 = 0; var11 < var10.length; ++var11) {
                     Entity var12 = var10[var11];
                     if(var12 != p_76588_1_ && var12.field_70121_D.func_72326_a(p_76588_2_)) {
                        p_76588_3_.add(var12);
                     }
                  }
               }
            }
   ...
   public void func_76618_a(Class p_76618_1_, AxisAlignedBB p_76618_2_, List p_76618_3_) {
      ...
      for(int var6 = var4; var6 <= var5; ++var6) {
         ...
         while(var8.hasNext()) {
            Entity var9 = (Entity)var8.next();
            if(p_76618_1_.isAssignableFrom(var9.getClass()) && var9.field_70121_D.func_72326_a(p_76618_2_)) {
               p_76618_3_.add(var9);
            }
         }
      }
   ...
   public boolean func_76601_a(boolean p_76601_1_) {
      if(p_76601_1_) {
         if(this.field_76644_m && this.field_76637_e.func_72820_D() != this.field_76641_n) {
            return true;
         }
      } else if(this.field_76644_m && this.field_76637_e.func_72820_D() >= this.field_76641_n + 600L) {
         return true;
      }
   ...
   public int func_76626_d(int p_76626_1_, int p_76626_2_) {
      ...
      if(var4 == -999) {
         ...
         while(var5 > 0 && var4 == -1) {
            ...
            Material var7 = var6 != 0?Block.field_71973_m[var6].field_72018_cp:Material.field_76249_a;
   ...
   public void func_76607_a(byte[] p_76607_1_, int p_76607_2_, int p_76607_3_, boolean p_76607_4_) {
      ...
      this.func_76590_a();
      Iterator var9 = this.field_76648_i.values().iterator();
