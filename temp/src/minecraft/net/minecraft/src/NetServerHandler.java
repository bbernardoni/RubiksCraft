...
public class NetServerHandler extends NetHandler {
   ...
   public NetServerHandler(MinecraftServer p_i3401_1_, NetworkManager p_i3401_2_, EntityPlayerMP p_i3401_3_) {
      this.field_72573_d = p_i3401_1_;
      this.field_72575_b = p_i3401_2_;
      p_i3401_2_.func_74425_a(this);
      this.field_72574_e = p_i3401_3_;
   ...
   public void func_72570_d() {
      ...
      if(!this.field_72584_h && !this.field_72574_e.field_71136_j) {
   ...
   public void func_72510_a(Packet14BlockDig p_72510_1_) {
      ...
      if(p_72510_1_.field_73342_e == 4) {
         ...
         boolean var3 = var2.field_73060_c = var2.field_73011_w.field_76574_g != 0 || this.field_72573_d.func_71203_ab().func_72353_e(this.field_72574_e.field_71092_bJ) || this.field_72573_d.func_71264_H();
         boolean var4 = false;
   ...
   public void func_72472_a(Packet15Place p_72472_1_) {
      ...
      boolean var9 = var2.field_73060_c = var2.field_73011_w.field_76574_g != 0 || this.field_72573_d.func_71203_ab().func_72353_e(this.field_72574_e.field_71092_bJ) || this.field_72573_d.func_71264_H();
      if(p_72472_1_.func_73401_h() == 255) {
         ...
         if(this.field_72587_r && this.field_72574_e.func_70092_e((double)var5 + 0.5D, (double)var6 + 0.5D, (double)var7 + 0.5D) < 64.0D && (var12 > 16 || var9)) {
   ...
   private void func_72566_d(String p_72566_1_) {
      if(this.field_72573_d.func_71203_ab().func_72353_e(this.field_72574_e.field_71092_bJ) || "/seed".equals(p_72566_1_)) {
         field_72577_a.info(this.field_72574_e.field_71092_bJ + " issued server command: " + p_72566_1_);
   ...
   public void func_72461_a(Packet203AutoComplete p_72461_1_) {
      ...
      String var3;
      for(Iterator var4 = this.field_72573_d.func_71248_a(this.field_72574_e, p_72461_1_.func_73473_d()).iterator(); var4.hasNext(); var2.append(var3)) {
   ...
   public void func_72501_a(Packet250CustomPayload p_72501_1_) {
      ...
      if("MC|BEdit".equals(p_72501_1_.field_73630_a)) {
         ...
         try {
            ...
            Container var9 = this.field_72574_e.field_71070_bA;
