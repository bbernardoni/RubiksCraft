...
public class NetServerHandler extends NetHandler
{
    ...
    public void handleAutoComplete(Packet203AutoComplete par1Packet203AutoComplete)
    {
        ...
        for (Iterator var4 = this.mcServer.getPossibleCompletions(this.playerEntity, par1Packet203AutoComplete.func_73473_d()).iterator(); var4.hasNext(); var2.append(var3))
        {
