...
public class GuiCubeSettings extends GuiScreen {
	...
	public void initGui(){
		...
		controlList.add(new GuiButton(2, (width-256)/2+15,  (height-176)/2+62, 112, 20, "Save This Session"));
	...
	protected void actionPerformed(GuiButton guibutton){
		...
		case 22:	cs[0] = 0xffffffff;	cs[1] = 0xffffff00; cs[2] = 0xff00ff00;
					cs[3] = 0xffff0000; cs[4] = 0xff0000ff; cs[5] = 0xffff8000;	break;
		default:}
	}
	...
	public void drawScreen(int i, int j, float f){
		...
		case 1:
			...
			centeredString(fontRenderer, "Verison 1.4", width/2, (height-176)/2+95, 0x000000);
		...
		case 3:
			...
			drawRect((width-256)/2+112, (height-176)/2+127, (width-256)/2+127, (height-176)/2+140, cs[2]);
			centeredString(fontRenderer, "F-4", (width-256)/2+139, (height-176)/2+130, 0x000000);
			drawRect((width-256)/2+150, (height-176)/2+127, (width-256)/2+165, (height-176)/2+140, cs[3]);
