...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float par1)
    {
        ...
        {
            var6 = var3.prevRenderArmPitch + (var3.renderArmPitch - var3.prevRenderArmPitch) * par1;
        ...
        if (var5 != null)
        {
            int var10 = Item.itemsList[var5.itemID].getColorFromDamage(var5.getItemDamage(), 0);
        ...
        if (var5 != null && var5.itemID == Item.map.shiftedIndex)
        {
            ...
            var12 = MathHelper.sin(var11 * (float)Math.PI);
            var13 = MathHelper.sin(MathHelper.sqrt_float(var11) * (float)Math.PI);
            GL11.glTranslatef(-var13 * 0.4F, MathHelper.sin(MathHelper.sqrt_float(var11) * (float)Math.PI * 2.0F) * 0.2F, -var12 * 0.2F);
            ...
            var11 = -MathHelper.cos(var11 * (float)Math.PI) * 0.5F + 0.5F;
            ...
            for (var12 = 0.0F; var12 < 2.0F; ++var12)
            {
                ...
                var25 = RenderManager.instance.getEntityRenderObject(this.mc.thePlayer);
            ...
            var13 = MathHelper.sin(var12 * var12 * (float)Math.PI);
            ...
            var28.draw();
            MapData var19 = Item.map.getMapData(var5, this.mc.theWorld);
            this.mapItemRenderer.renderMap(this.mc.thePlayer, this.mc.renderEngine, var19);
            GL11.glPopMatrix();
        }
        else if (var5 != null)
        {
            ...
            {
                EnumAction var21 = var5.getItemUseAction();

                if (var21 == EnumAction.eat || var21 == EnumAction.drink)
                {
                    var12 = (float)var3.getItemInUseCount() - par1 + 1.0F;
                    var13 = 1.0F - var12 / (float)var5.getMaxItemUseDuration();
                    var14 = 1.0F - var13;
                    var14 = var14 * var14 * var14;
                    var14 = var14 * var14 * var14;
                    var14 = var14 * var14 * var14;
                    var15 = 1.0F - var14;
                    GL11.glTranslatef(0.0F, MathHelper.abs(MathHelper.cos(var12 / 4.0F * (float)Math.PI) * 0.1F) * (float)((double)var13 <= 0.2D ? 0 : 1), 0.0F);
            ...
            GL11.glEnable(GL12.GL_RESCALE_NORMAL);
            var11 = var3.getSwingProgress(par1);
            var12 = MathHelper.sin(var11 * var11 * (float)Math.PI);
            var13 = MathHelper.sin(MathHelper.sqrt_float(var11) * (float)Math.PI);
            ...
            if (var3.getItemInUseCount() > 0)
            {
                EnumAction var23 = var5.getItemUseAction();
                ...
                else if (var23 == EnumAction.bow)
                {
                    ...
                    var16 = (float)var5.getMaxItemUseDuration() - ((float)var3.getItemInUseCount() - par1 + 1.0F);
                    var17 = var16 / 20.0F;
            ...
            if (var5.getItem().requiresMultipleRenderPasses())
            {
                this.renderItem(var3, var5, 0);
                int var26 = Item.itemsList[var5.itemID].getColorFromDamage(var5.getItemDamage(), 1);
        ...
        else
        {
            ...
            var12 = MathHelper.sin(var11 * (float)Math.PI);
            var13 = MathHelper.sin(MathHelper.sqrt_float(var11) * (float)Math.PI);
            GL11.glTranslatef(-var13 * 0.3F, MathHelper.sin(MathHelper.sqrt_float(var11) * (float)Math.PI * 2.0F) * 0.4F, -var12 * 0.4F);
